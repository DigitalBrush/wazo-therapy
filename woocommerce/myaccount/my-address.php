...
<?php foreach ( $get_addresses as $name => $title ) : ?>
	...
	<div class="u-column woocommerce-Address">
		<header class="woocommerce-Address-title title">
			...
			<a href="<?php echo esc_url( wc_get_endpoint_url( 'edit-address', $name ) ); ?>" class="edit"><?php _e( 'Edit', 'wazotherapy' ); ?></a>
		</header>
		<address><?php
			$address = wc_get_account_formatted_address( $name );
			echo $address ? wp_kses_post( $address ) : esc_html_e( 'You have not set up this type of address yet.', 'wazotherapy' );
		?></address>
	</div>
