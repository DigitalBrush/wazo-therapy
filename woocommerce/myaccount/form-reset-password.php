...
<form method="post" class="woocommerce-ResetPassword lost_reset_password">
	...
	<p class="woocommerce-form-row woocommerce-form-row--first form-row form-row-first">
		<label for="password_1"><?php esc_html_e( 'New password', 'wazotherapy' ); ?>&nbsp;<span class="required">*</span></label>
	...
	<p class="woocommerce-form-row woocommerce-form-row--last form-row form-row-last">
		<label for="password_2"><?php esc_html_e( 'Re-enter new password', 'wazotherapy' ); ?>&nbsp;<span class="required">*</span></label>
	...
	<p class="woocommerce-form-row form-row">
		...
		<button type="submit" class="btn btn-outline-primary" value="<?php esc_attr_e( 'Save', 'wazotherapy' ); ?>"><?php esc_html_e( 'Save', 'wazotherapy' ); ?></button>
	</p>
